...
import { TableReservationDialogComponent } from '../dialogs/table-reservation-dialog/table-reservation-dialog.component';
...
export class ReservationComponent implements OnInit {
  ...
  tableDialog(): void {
    this.dialog.open(TableReservationDialogComponent);
  }
